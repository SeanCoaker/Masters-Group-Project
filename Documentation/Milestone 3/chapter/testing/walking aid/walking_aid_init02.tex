...
\begin{tabular}{| m{0.97\textwidth} |} 
    ...
    \hline
    \textbf{Assert Specification(s):} The walking aid device should transition from the background to the foreground with use of the onboard LED and through the playing of audio through the audio shield.\\ 
    \hline
