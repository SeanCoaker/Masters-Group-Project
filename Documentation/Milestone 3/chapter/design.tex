        ...
        \label{ch:design}
            ...
            \label{sec:walking_aid}
                ...
                \label{subsec:Design_Decisions_walking_aid}
                    ...
                    \input{graphics/cad/walkingaid_0.tex}
                    ...
                    To fulfil the specification, and allow for familiar voices to remind the users, a MicroSD card was chosen as described above. This required easy access to the card slot, which had to be intuitive and accessible without disassembly of the device.
        
                    \input{graphics/cad/walkingaid_0_1.tex}
                ...
                \label{subsec:prototype_walking_aid}
                    ...
                    \input{graphics/prototype/walkingaid_1.tex}
                    ...
                    \input{graphics/prototype/walkingaid_2.tex}
            ...
            \label{sec:wearabledevice}
                ...
                \label{subsec:Design_Decisions_wearable}
                    ...
                    \input{graphics/cad/wearable_components_1.tex} %%also includes endcase
                    ...
                    \input{graphics/cad/wearable_0.tex}
                    ...
                    \input{graphics/cad/wearable_clip_0.tex}
                    ...
                    \input{graphics/cad/wearable_strap_0.tex}
                ...
                \label{subsec:Prototype_wearable}
                    ...
                    \input{graphics/prototype/wearable_0.tex}
                    ...
                    \input{graphics/prototype/attachments.tex}
                    ...
                    \input{graphics/prototype/watchstrap_0.tex}
